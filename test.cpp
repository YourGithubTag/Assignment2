...
TestResult testTransactionTwo() {
	...
	cout << jamesCheque->getBalance().asCents() << endl;
...
/*
 *  48 test when 0 transactions are input that performPendingTransactions
...
/*
 * 49 Test order longer (5 transactions)
 */
...
/*
 *  50Test 1 for this particular case (multiple are needed)
...
/*
 *  51Test all account types are added correctly
...
/*
 *  52 Test transactions are added correctly
 */
...
/*
 *  55 Test that when 0 dollar transactions
...
/*
 *  56 Test that a overall balance of less than 0 can be returned
 */
...
/*
 *  57Test that the customer account balance can be 0 dollars total.
 */
...
/*
 57 This function collects up all the tests as a vector of function pointers. If you create your own
